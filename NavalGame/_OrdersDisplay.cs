...
namespace NavalGame
{
    public class _OrdersDisplay : PictureBox
    {
        ...
        public _OrdersDisplay(MapDisplay mapDisplay)
        {
        ...
        protected override void OnPaint(PaintEventArgs pe)
        {
            ...
            if (MapDisplay.Game.SelectedUnit != null)
            {
                ...
                for (int i = 0; i < ButtonLocations.Count; i++)
                {
                    ...
                    if (MapDisplay.CurrentOrder == Order.Move && MapDisplay.Game.SelectedUnit.Abilities[i] == Order.Move)
                    {
        ...
        protected override void OnMouseUp(MouseEventArgs e)
        {
            if (ButtonPressedIndex != -1)
            {
                ...
                {
                    if (MapDisplay.CurrentOrder == Order.Move)
                    {
